...
//% advanced=true
//% block="tools" // English
//% block.loc.zh-cn="工具" // Chinese
//% block.loc.zh-tw="工具" //  Chinese
...
namespace tools
{
    ...
    //% block.loc.zh-cn="抛出错误 $error" // Chinese
    //% block.loc.zh-tw="拋出錯誤 $error" // Chinese
    //% block.loc.de="Fehler werfen $error" // German
    //% block.loc.fr="lancer une erreur $error" // French
    //% block.loc.ja="エラーを投げる $error" // Japanese
    //% block.loc.es-es="lanzar error $error" // Spanish 
    //% block.loc.es-mx="lanzar error $error" // Spanish 
